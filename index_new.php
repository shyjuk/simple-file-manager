...
$PASSWORD = '1';  // Set the password, to access the file manager... (optional)
...
#file_drop_target {width:500px; padding:12px; border: 4px dashed #ccc;font-size:12px;color:#ccc;
	text-align: center;float:left;margin-right:20px; margin-top:20px;}
...
#breadcrumb { padding-top:14px; padding-bottom:5px; font-size:15px; color:#aaa;display:inline-block;float:left;}
	...
	function list() {
		...
		$.get('?',{'do':'list','file':hashval},function(data) {
			...
			if(data.success) {
				...
				data.is_writable ? $('body').addClass('show_warn') : $('body').removeClass('show_warn');
...
<div id="show_warn"  style="color:#FF00FF">Can not upload? Try setting permission. Example: chown www-data:www-data sfm-directory </div>
</body></html>
